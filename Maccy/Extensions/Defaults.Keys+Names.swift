...
extension Defaults.Keys {
  ...
  static let fontSize = Key<Double>("fontSize", default: 13, suite: preferencesSuite)
  ...
  static let popupHeightPercent = Key<Double>("popupHeightPercent", default: 1.0, suite: preferencesSuite)
