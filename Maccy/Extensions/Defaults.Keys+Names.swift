...
extension Defaults.Keys {
  ...
  static let appearanceMode = Key<AppearanceMode>("appearanceMode", default: .light, suite: preferencesSuite)
  static let backgroundOpacity = Key<Double>("backgroundOpacity", default: 1.0, suite: preferencesSuite)
  static let itemGap = Key<Double>("itemGap", default: 5, suite: preferencesSuite)
  ...
  static let highlightMatch = Key<HighlightMatch>("highlightMatch", default: .coloredText, suite: preferencesSuite)
  static let highlightMatchColor = Key<String>("highlightMatchColor", default: "#D45247", suite: preferencesSuite)
  static let fontSize = Key<Double>("fontSize", default: 11, suite: preferencesSuite)
  ...
  static let popupHeightPercent = Key<Double>("popupHeightPercent", default: 0.65, suite: preferencesSuite)
  ...
  static let size = Key<Int>("historySize", default: 100_000, suite: preferencesSuite)
  static let maxVisibleItems = Key<Int>("maxVisibleItems", default: 200, suite: preferencesSuite)
  ...
  static let previewWidth = Key<CGFloat>("previewWidth", default: 260, suite: preferencesSuite)
}
